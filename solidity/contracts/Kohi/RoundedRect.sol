...
library RoundedRectMethods {
        ...
        returns (VertexData[] memory results)
    {
        ...
        Vector2 memory v0 = MatrixMethods.transform(
            self.transform,
            Vector2(
                Fix64V1.add(self.bounds.left, self.leftBottomRadius.x),
                Fix64V1.add(self.bounds.bottom, self.leftBottomRadius.y)
            )
        );
        ...
        count = join(
            ...
            ArcMethods.create(
                v0.x,
                Fix64V1.sub(self.yShift * Fix64V1.ONE, v0.y),
                self.leftBottomRadius.x,
                self.leftBottomRadius.y,
                Fix64V1.PI,
                Fix64V1.add(Fix64V1.PI, Fix64V1.PI_OVER_2)
            ),
            count
        );
        ...
        Vector2 memory v1 = MatrixMethods.transform(
            self.transform,
            Vector2(
                Fix64V1.sub(self.bounds.right, self.rightBottomRadius.x),
                Fix64V1.add(self.bounds.bottom, self.rightBottomRadius.y)
            )
        );
        ...
        count = join(
            ...
            ArcMethods.create(
                v1.x,
                Fix64V1.sub(self.yShift * Fix64V1.ONE, v1.y),
        ...
        Vector2 memory v2 = MatrixMethods.transform(
            self.transform,
            Vector2(
                Fix64V1.sub(self.bounds.right, self.rightTopRadius.x),
                Fix64V1.sub(self.bounds.top, self.rightTopRadius.y)
            )
        );
        ...
        count = join(
            ...
            ArcMethods.create(
                v2.x,
                Fix64V1.sub(self.yShift * Fix64V1.ONE, v2.y),
        ...
        Vector2 memory v3 = MatrixMethods.transform(
            self.transform,
            Vector2(
                Fix64V1.add(self.bounds.left, self.leftTopRadius.x),
                Fix64V1.sub(self.bounds.top, self.leftTopRadius.y)
            )
        );
        ...
        count = join(
            ...
            ArcMethods.create(
                v3.x,
                Fix64V1.sub(self.yShift * Fix64V1.ONE, v3.y),
